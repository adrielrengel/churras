...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { categoria_id: @produto.categoria_id, nome: @produto.nome, situacao: @produto.situacao, unidade_id: @produto.unidade_id, usuario_id: @produto.usuario_id, valor: @produto.valor }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { categoria_id: @produto.categoria_id, nome: @produto.nome, situacao: @produto.situacao, unidade_id: @produto.unidade_id, usuario_id: @produto.usuario_id, valor: @produto.valor }
    assert_redirected_to produto_path(assigns(:produto))
  end
