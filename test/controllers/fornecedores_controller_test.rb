...
class FornecedoresControllerTest < ActionController::TestCase
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post :create, fornecedor: { cnpj: @fornecedor.cnpj, endereco_id: @fornecedor.endereco_id, nome: @fornecedor.nome, razao_social: @fornecedor.razao_social, situacao: @fornecedor.situacao, usuario_id: @fornecedor.usuario_id }
    end
  ...
  test "should update fornecedor" do
    patch :update, id: @fornecedor, fornecedor: { cnpj: @fornecedor.cnpj, endereco_id: @fornecedor.endereco_id, nome: @fornecedor.nome, razao_social: @fornecedor.razao_social, situacao: @fornecedor.situacao, usuario_id: @fornecedor.usuario_id }
    assert_redirected_to fornecedor_path(assigns(:fornecedor))
  end
