...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { endereco_id: @pessoa.endereco_id, nome: @pessoa.nome, situacao: @pessoa.situacao, usuario_id: @pessoa.usuario_id }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { endereco_id: @pessoa.endereco_id, nome: @pessoa.nome, situacao: @pessoa.situacao, usuario_id: @pessoa.usuario_id }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
