...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { complemento: @endereco.complemento, numero: @endereco.numero, rua_id: @endereco.rua_id, usuario_id: @endereco.usuario_id }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { complemento: @endereco.complemento, numero: @endereco.numero, rua_id: @endereco.rua_id, usuario_id: @endereco.usuario_id }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
