...
class CategoriaProdutosControllerTest < ActionController::TestCase
  ...
  test "should create categoria_produto" do
    assert_difference('CategoriaProduto.count') do
      post :create, categoria_produto: { nome: @categoria_produto.nome, situacao: @categoria_produto.situacao, usuario_id: @categoria_produto.usuario_id }
    end
  ...
  test "should update categoria_produto" do
    patch :update, id: @categoria_produto, categoria_produto: { nome: @categoria_produto.nome, situacao: @categoria_produto.situacao, usuario_id: @categoria_produto.usuario_id }
    assert_redirected_to categoria_produto_path(assigns(:categoria_produto))
  end
